...
(function initAdminWorkspaceRegistry() {
  ...
  const definitions = Object.freeze([
    ...
    Object.freeze({ id: "catalog-management", title: "Catalog Management", eyebrow: "ADMIN / REUSABLE DEFINITIONS", description: "Canonical definition catalogs, Equipment authoring, validation and data-pack export.", modules: [], bundleId: "admin-workspace-catalog-management" }),
    Object.freeze({ id: "cyberware-runtime", title: "Cyberware Runtime", eyebrow: "ADMIN / INSTALLED SYSTEMS", description: "Installed cyberware, Core Stack, diagnostics and canonical world/direct operations.", modules: [], bundleId: "admin-workspace-cyberware-runtime" }),
